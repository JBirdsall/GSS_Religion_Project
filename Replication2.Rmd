...
```{r}
# We are working w
ith the GSS cumulative data. We downloaded the Stata file from:    Because we are using a Stata file, we have to install the foreign package in order to read it. 
